    ...
    <div className='z-10 absolute w-screen'>
      <Container>
        <div className='flex -mx-6 uppercase text-sm'>
          ...
          <nav className={'opacity-0 pointer-events-none text-blue fixed z-0 inset-0 bg-white pt-20 lg:relative lg:inset-auto lg:py-8 lg:flex-grow lg:w-1/2 lg:block lg:opacity-100 transition transform scale-90 lg:transition-none lg:pointer-events-auto' + (navActive ? ' opacity-100 scale-100 pointer-events-auto' : '')}>
            <ul className='flex flex-col h-full justify-center lg:flex-row lg:justify-end'>
              <li className='mb-12 text-lg text-center lg:pl-6 lg:pr-4'>
                <NextLink href={'/philosophy'}>
                  <a className='hover:underline'>{ t('philosophy') }</a>
                </NextLink>
              </li>
              <li className='mb-12 text-lg text-center lg:px-4'>
              ...
              <li className='mb-12 text-lg text-center lg:pl-4 lg:pr-6'>
          ...
          <div className='w-1/3 pt-4 text-right text-blue relative z-10'>
